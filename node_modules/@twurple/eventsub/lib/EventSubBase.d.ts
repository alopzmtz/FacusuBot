...
export declare abstract class EventSubBase extends EventEmitter {
     ...
     * @param handler The function that will be called for any new notifications.
     */
    subscribeToChannelGoalBeginEvents(user: UserIdResolvable, handler: (data: EventSubChannelGoalBeginEvent) => void): Promise<EventSubSubscription>;
    /**
     ...
     * @param handler The function that will be called for any new notifications.
     */
    subscribeToChannelGoalProgressEvents(user: UserIdResolvable, handler: (data: EventSubChannelGoalProgressEvent) => void): Promise<EventSubSubscription>;
    /**
     ...
     * @param handler The function that will be called for any new notifications.
     */
    subscribeToChannelGoalEndEvents(user: UserIdResolvable, handler: (data: EventSubChannelGoalEndEvent) => void): Promise<EventSubSubscription>;
    /**
